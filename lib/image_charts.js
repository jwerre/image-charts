...
const os = require('os'),
	...
	configFile = process.env.IMAGE_CHARTS_AUTH || path.resolve(os.homedir(), '.image_charts.json'),
	RESOURCES_DIR = './resources',
	DEFAULT_PROTOCOL = 'https',
	DEFAULT_HOST = 'image-charts.com',
	DEFAULT_PATH = 'chart',
	DEFAULT_PORT = '443',
...
class ImageCharts {
	...
	constructor(options={}) {
		...
		this._api = {
			...
			secret: options.key || config.key || process.env.IMAGE_CHARTS_SECRET,
